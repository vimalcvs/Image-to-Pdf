...
import com.vimalcvs.pdfreader.ImageToPDF;
...
public class ImageToPDFAsync extends AsyncTask<Void, Integer, Boolean> {
    ...
    protected Boolean doInBackground(Void... voids) {
        ...
        try {
            ...
            for (int i = 0; i < mdocuments.size(); i++) {
                ...
                if (this.pageSize.equals("Fit (Same page size as image)")) {
    ...
    public void onPostExecute(Boolean bool) {
        imageToPDF.runPostExecution();
    }

    public void onCancelled(Boolean bool) {
        if (this.mListener != null) {
            this.mListener.onPostExecute(this, Boolean.FALSE);
        }
    }
